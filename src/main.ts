...
class CustomIoAdapter extends IoAdapter {
  createIOServer(port: number, options?: ServerOptions): any {
    const server = super.createIOServer(port, {
      ...options,
      cors: {
        origin: ['http://localhost:3000', 'http://localhost:5000', 'http://localhost:5001', 'http://localhost:5002', 'http://192.168.0.127:5000', 'http://192.168.0.127:5002', 'https://timeboard.site', 'https://app.timeboard.site'],
...
async function bootstrap() {
  ...
  const allowedOrigins = nodeEnv === 'production'
    ...
    : ['http://localhost:3000', 'http://localhost:5000', 'http://localhost:5001', 'http://localhost:5002', 'http://192.168.0.127:5000', 'http://192.168.0.127:5002'];
